...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Bootstrap 5 (CDN) -->
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">        <!-- Optional local app CSS can be linked via Vite in layouts; omitted here for simplicity -->
    </head>
    <body class="bg-light text-dark d-flex p-4 p-lg-5 align-items-center justify-content-center min-vh-100 flex-column">
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+6u9gq0j0x0x0x0x0x0x0" crossorigin="anonymous" defer></script>
    </body>
</html>
